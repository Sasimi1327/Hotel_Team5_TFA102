		...
		<div id="layoutSidenav_content">
			...
			<div class="wrapper">
				<div class='content'>
					...
					<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/empSelfServlet"
						name="form2">
						<div class="container rounded" id="main">
							<div class="row">
								...
								<div class="mb-3 row">
									...
									<div class="col-sm-9">
										     <input type="text" class="form-control" id="empname" name="emp_name"  value="<%=empVO.getEmp_name()%>">
									</div>
								</div>
								<div class="mb-3 row">
								...
								<div class="mb-3 row">
									...
									<div class="col-sm-9">
										      <input type="text" class="form-control" id="empphone" name="emp_phone" value="<%=empVO.getEmp_phone()%>">
									</div>
								</div>
								<div class="mb-3 row">
								...
								<div class="mb-3 row">
									...
									<div class="col-sm-9">
										       <input class="form-control" type="text" id="emppassword" name="password" value="<%=empVO.getPassword()%>" aria-label="readonly input example" >
									</div>
								</div>
								<div class="mb-3 row">
									<label for="confirm_password" class="col-sm-3 col-form-label">確認密碼</label>
									<div class="col-sm-9">
										       <input class="form-control" type="text" id="confirm_password" name="confirm_password" value="<%=empVO.getPassword()%>" aria-label="readonly input example" >
									</div>
								</div>
								<div class="mb-3 row">
									...
									<div class="row ">
										<div class="row justify-content-center">
											<a class="col-5 col-md-4 col-lg-3"
												href="<%=request.getContextPath()%>/DH_backsystem/memberdata.jsp">
