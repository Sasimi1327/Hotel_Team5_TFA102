				...
				<div class="sb-sidenav-menu">
					<div class="nav">
						...
						<div class="collapse" id="collapseRestaurant"
							aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
							<nav class="sb-sidenav-menu-nested nav">
								<a class="nav-link" href="res_submit.jsp">菜餚管理</a> <a
									class="nav-link" href="resbooking_management.jsp">座位管理</a> <a
									class="nav-link" href="resbooking_management.jsp">餐廳平面圖</a>
