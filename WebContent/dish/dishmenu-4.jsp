...
<title>夢想假期湯品餐點頁面-1 DreamHoliday</title>
		...
		<div class="row ">
			<div class="row justify-content-start">
				<a class="col-6 col-md-3 col-lg-2" href="dishmenu-1.jsp#targetPoint">
					...
					href="dishmenu-3.jsp#targetPoint"> <!-- <input type="radio" class="btn-check" name="options-outlined" id="primary-outlined" autocomplete="off"> -->
					...
					id="warning-outlined" autocomplete="on" checked> <label
					class="btn btn-outline-warning container" for="warning-outlined">湯品</label>
				</a>
			</div>
		</div>
	</div>
	<div class="photo container">
		<div class="row justify-content-center">
			...
			<c:forEach var="dishVO" items="${list}" >
					<c:if test="${dishVO.dishType == 3 && dishVO.dishStatus == 1}">
