			...
			<div class="container">
				<div class="row">
					...
					<table class="table table-striped">
						...
						<a href='addDish.jsp' class="aLink">新增</a>
						</div>
						<c:forEach var="dishVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
							...
							<tr>
								...
								<td>${mapSvc.getDishTypeByKey(dishVO.dishType).dishTypeName}</td>
								<td>${mapSvc.getDishStatusByKey(dishVO.dishStatus).dishStatusName}</td>
								<td>
									<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/dish/DishServlet" style="margin-bottom: 0px;">
