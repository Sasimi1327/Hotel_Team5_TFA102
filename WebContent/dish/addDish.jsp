...
<body class="sb-nav-fixed">
			...
			<div class="container">
				<div class="row">
					<table id="table-1">
						<tr>
							<td>
								 <h4>菜餚資料修改 - addDish.jsp</h4>
								 <h4><a href="listAllDish.jsp"><img src="<%=request.getContextPath()%>/images/logo.png" width="100" height="32" border="0">回首頁</a></h4>
							</td>
						</tr>
					</table>
					...
					<FORM METHOD="post" ACTION="DishServlet" name="form1" enctype="multipart/form-data">
						...
						<table class="table table-striped">
							<tr>
								<td>菜餚名稱:</td>
								<td>
									<input type="text" name="dishName" style="width: 400px;"
							...
							<tr>
								<td>菜餚價格:</td>
								<td>
									<input type="text" name="dishPrice" style="width: 400px;"
									 value="<%= (dishVO==null)? "0" : dishVO.getDishPrice()%>" />
								</td>
							</tr>
							<tr>
								<td>菜餚介紹:</td>
								<td>		
									<textarea  name="dishIntro" rows="5" cols="10" style="width:400px; text-align: left"><%= (dishVO==null)? "" : dishVO.getDishIntro() %></textarea>
								</td>
							</tr>
							...
							<tr>
								<td>菜餚圖片:</td>
								<td><img id="showPicture" src="DBPicReader" style="width: 200px; height: 200px"></td>
							</tr>
							<tr>
								<td>檔案上傳:</td>
	...
	<!-- 							<td>菜餚名稱:</td> -->
	<!-- 							<td> -->
	<!-- 								<input type="text" name="dishName" size="45"  -->
	<%-- 								 value="<%= (dishVO==null)? "" : dishVO.getDishName()%>" /> --%>
	<!-- 							</td> -->
	<!-- 						</tr> -->
	<!-- 						<tr> -->
	<!-- 							<td>菜餚價格:</td> -->
	<!-- 							<td> -->
	<!-- 								<input type="text" name="dishPrice" size="45" -->
	<%-- 								 value="<%= (dishVO==null)? "0" : dishVO.getDishPrice()%>" /> --%>
	<!-- 							</td> -->
	<!-- 						</tr> -->
	<!-- 						<tr> -->
	<!-- 							<td>菜餚介紹:</td> -->
	<!-- 							<td>		 -->
	<%-- 								<textarea  name="dishIntro" rows="5" cols="10" style="width:350px; text-align: left"><%= (dishVO==null)? "" : dishVO.getDishIntro() %></textarea> --%>
	<!-- 							</td> -->
	<!-- 						</tr> -->
	...
	<!-- 							<td>菜餚類別:</td> -->
	<!-- 							<td> -->
	<!-- 								<select size="1" name="dishType" style="width: 350px;"> -->
	<%-- 									<c:forEach var="dishTypeVO" items="${mapSvc.getDishTypeAll()}"> --%>
	<%-- 										<option value="${dishTypeVO.dishType}" ${(dishVO.dishType==dishTypeVO.dishType)?'selected':'' } >${dishTypeVO.dishTypeName} --%>
	<%-- 									</c:forEach> --%>
	<!-- 								</select> -->
	...
	<!-- 							<td>菜餚狀態:</td> -->
	<!-- 							<td> -->
	<!-- 								<select size="1" name="dishStatus" style="width: 350px;"> -->
	<%-- 									<c:forEach var="dishStatusVO" items="${mapSvc.getDishStatusAll()}"> --%>
	<%-- 										<option value="${dishStatusVO.dishStatus}" ${(dishVO.dishStatus==dishStatusVO.dishStatus)?'selected':'' } >${dishStatusVO.dishStatusName} --%>
	<%-- 									</c:forEach> --%>
	<!-- 								</select> -->
