...
<title>夢想假期中式餐點頁面-1 DreamHoliday</title>
							...
							<div class="collapse" id="collapseSetting"
								...
								<nav class="sb-sidenav-menu-nested nav accordion"
									...
									<a class="nav-link" href="dishMain.jsp">線上預約</a> <a
										class="nav-link" href="dishmenu-1.html">菜色樣式</a>
								</nav>
							</div>
							<a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
								data-bs-target="#collapseSetting" aria-expanded="false"
	...
	<div class="menu container">
		<div class="row ">
			<div class="row justify-content-start">
				<a class="col-6 col-md-3 col-lg-2" id="targetPoint" href="#"> <input
					type="radio" class="btn-check" name="options-outlined"
					id="success-outlined" autocomplete="on" checked> <label
					class="btn btn-outline-success container" for="success-outlined">中式</label>
				</a> <a class="col-6 col-md-3 col-lg-2"
					href="dishmenu-2.jsp#targetPoint"> <!-- <input type="radio" class="btn-check" name="options-outlined" id="danger-outlined" autocomplete="on" checked> -->
					<label class="btn btn-outline-danger container"
					for="danger-outlined">西式</label>
				</a> <a class="col-6 col-md-3 col-lg-2"
	...
	<div class="photo container">
		<div class="row justify-content-center">
			<c:forEach var="dishVO" items="${list}" >
				<c:if test="${dishVO.dishType == 0 && dishVO.dishStatus == 1}">
