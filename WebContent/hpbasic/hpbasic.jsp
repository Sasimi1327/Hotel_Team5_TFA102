                ...
                <div class="topmenu col-auto">                          
                    <ul id="menu-1">
                        <span class="member">會員專區</span> 
                      		 <li><a href="<%=request.getContextPath()%>/loginTest1.jsp">會員登入</a></li>
               				 <li><a href="<%=request.getContextPath()%>/MemberCreateAccount.jsp">註冊會員</a></li>
                         	 <li><a href="<%=request.getContextPath()%>/MemberList.jsp">會員資料</a></li>
